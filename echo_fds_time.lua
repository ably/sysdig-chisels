...
function on_event()
  ...
  if isread then
    ...
    name_pname = string.format("%s [%s] %s (%s)", terminal.red, ftime, name, pname );
    ...
    name_pname = string.format("%s [%s] (%s)", terminal.blue, ftime, name, pname );
